...
def parse_arg():
    ...
    #Env args
    parser.add_argument('--train-env', default='./src/scenario/scenario_train_v2.yaml', type=str, help='train env file')
    parser.add_argument('--search-env', default='./src/scenario/scenario_search_v2.yaml', type=str, help='search env file')
    parser.add_argument('--eval-env', default='./src/scenario/scenario_train_v2.yaml', type=str, help='eval env file')
